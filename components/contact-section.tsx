  ...
  return (
    <section id="contact" className="py-24 md:py-32 bg-background border-t border-border/50">
      <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 gap-4">
            {contactLinks.map((link, index) => (
              <a
                ...
                className="flex items-center gap-5 p-4 md:p-5 bg-card border border-border rounded-[1.5rem] hover:shadow-xl hover:border-primary/30 transition-all duration-500 group"
              >
        ...
        <footer className="mt-32 pt-12 border-t border-border flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
