            ...
            <div className="relative">
              ...
              >
                {toolsWithIcons.map((tool, index) => (
                  <div
                    key={tool.name}
                    className="flex-shrink-0 bg-card border border-border rounded-lg px-4 md:px-6 py-3 md:py-4 shadow-sm hover:shadow-md transition-all hover:scale-105 hover:-translate-y-1 animate-in fade-in scale-in-95 duration-300"
